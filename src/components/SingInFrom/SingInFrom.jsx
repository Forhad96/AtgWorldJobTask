...
const SignInForm = ({ setIsSingUpPage }) => {
  return (
    <>
      <div className="bg-[#EFFFF4] w-full rounded-lg text-center py-5">
        ...
        <div className="ml-8 flex-1">
          <div>
            <div href="" className="text-sm">
              ...
              <span onClick={()=>setIsSingUpPage(true)} className="link text-blue-500">
                Create new for free!
              </span>
            </div>
          </div>
